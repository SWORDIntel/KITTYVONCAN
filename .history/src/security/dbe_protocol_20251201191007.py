...
# Add paths for quantum crypto layer (relative to KITTYVONCAN)
_kittyvoncan_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
_dsmil_root = os.path.dirname(_kittyvoncan_root)  # DSMILSystem
sys.path.insert(0, _dsmil_root)
